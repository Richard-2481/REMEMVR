...
print(f"[SUCCESS] Parsed UID and test from composite_ID")
...
print(f"[SUCCESS] Parsed item metadata")
...
print(f"\n[INFO] Filtered to paradigms {paradigms}: {len(long_data):,} observations")
...
print(f"\n[SUCCESS] Saved item-level data: {output_path}")
