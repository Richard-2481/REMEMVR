#!/usr/bin/env python3
"""Fit LMM Trajectory Models: Fit 5 candidate LMM trajectory models with Domain x Time interaction, select best by AIC."""
...
if __name__ == "__main__":
    try:
        log("Step 05: Fit LMM Trajectory Models")
        log("=" * 60)
        # Load Input Data
