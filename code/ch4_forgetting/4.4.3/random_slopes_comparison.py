...
"""
===============================================================================
RQ 5.4.3 - Random Slopes Comparison (MANDATORY PLATINUM REQUIREMENT)
===============================================================================
...
def main():
    ...
    log("[INFO] Model formula: Full 3-way Age × Congruence × Time interaction")
    ...
    log("-" * 70)
    log("[INFO] Testing if individual differences in rapid forgetting rate exist")
    log("")
    ...
    if not model_A_success or not model_B_success:
        log("[ERROR] Cannot compare models - one or both failed to converge")
        log("")
