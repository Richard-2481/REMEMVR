"""
PLATINUM TASK 5: Post-Hoc Power Verification
...
logprint("=" * 70)
logprint("PLATINUM TASK 5: Post-Hoc Power Verification")
logprint("=" * 70)
logprint("")

# Load TOST results (has observed Cohen's d)
logprint("[LOAD] Loading TOST results for observed effect sizes...")
tost_path = RESULTS_DIR / "platinum_task03_tost_equivalence.csv"
tost = pd.read_csv(tost_path)

logprint(f"[LOADED] {len(tost)} contrasts")
logprint("")
