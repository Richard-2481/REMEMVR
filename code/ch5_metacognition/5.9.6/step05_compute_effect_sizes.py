...
"""
Step ID: step05
Step Name: Compute Effect Sizes for Practice Magnitude Comparison
RQ: results/ch6/6.9.6
Generated: 2026-01-19

PURPOSE:
Compute Cohen's d effect sizes for T1->T2 improvement in both measures to quantify
magnitude of practice effects. Calculate effect size for saturation ratio difference
using bootstrap SD. Post-hoc power analysis for observed effects.

EXPECTED INPUTS:
- results/ch6/6.9.6/data/step02_confidence_intervals_wide.csv
  Columns: ['UID', 'delta_T1_T2']
  Expected rows: ~100
  Purpose: Confidence T1->T2 improvements
- results/ch5/5.1.2/data/step02_accuracy_intervals_wide.csv
  Columns: ['UID', 'delta_T1_T2_accuracy'] (or similar)
  Purpose: Accuracy T1->T2 improvements (fallback: compute from raw data)
- results/ch6/6.9.6/data/step03_ratio_comparison.csv
  Columns: ['diff_ratio', ...]
  Purpose: Ratio difference for effect size computation

EXPECTED OUTPUTS:
- results/ch6/6.9.6/data/step05_effect_sizes.csv
  Columns: ['comparison', 'cohen_d', 'ci_lower', 'ci_upper', 'interpretation']
  Rows: 3 (confidence T1->T2, accuracy T1->T2, ratio difference)
  Purpose: Effect sizes with interpretations
- results/ch6/6.9.6/data/step05_power_analysis.csv
  Columns: ['measure', 'cohen_d', 'achieved_power', 'interpretation']
  Rows: 2 (confidence, accuracy)
  Purpose: Post-hoc power analysis

VALIDATION CRITERIA:
- Exactly 3 rows in effect_sizes
- Exactly 2 rows in power_analysis
- Cohen's d values in [-3, 3] (typical behavioral data range)
- Achieved power in [0, 1]

g_code REASONING:
- Approach: Standard Cohen's d formula: d = mean / SD for within-subject deltas;
  pooled SD from bootstrap for ratio difference; statsmodels power analysis
- Why this approach: Cohen's d standardized effect size for comparability across measures;
  bootstrap SD accounts for sampling variability in ratio estimates
- Data flow: Wide deltas -> Cohen's d -> power analysis -> interpretations
- Expected performance: ~5 seconds (simple arithmetic + power calculations)

IMPLEMENTATION NOTES:
- Analysis tool: stdlib + statsmodels.stats.power.TTestPower
- Validation tool: tools.validation.validate_effect_sizes
- Parameters: Cohen (1988) thresholds: Small=0.2, Medium=0.5, Large=0.8
"""
# =============================================================================
...
if __name__ == "__main__":
    try:
        ...
        # =====================================================================
        # STEP 4: Compute Cohen's d for Ratio Difference
        # =====================================================================
        ...
        # =====================================================================
        # STEP 5: Compute Bootstrap CIs for Effect Sizes (Simplified)
        # =====================================================================
        ...
        # =====================================================================
        # STEP 6: Post-Hoc Power Analysis
        # =====================================================================
        log("\n[POWER] Conducting post-hoc power analysis...")
        ...
        # =====================================================================
        # STEP 7: Save Effect Sizes
        # =====================================================================
        log(f"\n[SAVE] Saving effect sizes...")
        ...
        log(f"[SAVED] {OUTPUT_EFFECT_SIZES} ({len(df_effect_sizes)} rows)")

        # =====================================================================
        # STEP 8: Save Power Analysis
        # =====================================================================
        log(f"\n[SAVE] Saving power analysis...")
        ...
        log(f"[PASS] Power values in valid range [0, 1]")
