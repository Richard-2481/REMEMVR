...
EXPECTED INPUTS:
  ...
  - data/step00_q_matrix.csv
    ...
    Format: Q-matrix specifying 2-factor structure
...
g_code REASONING:
- Approach: 2-factor GRM using IWAVE variational inference with Q-matrix structure
...
if __name__ == "__main__":
    try:
        log("[START] Step 01: IRT Calibration Pass 1 (2-factor GRM on all TC_* items)")
        ...
        # Purpose: Prepare data for 2-factor IRT calibration
        ...
        log("[ANALYSIS] Configuring 2-factor GRM model via configure_irt_model...")
