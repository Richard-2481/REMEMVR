...
PURPOSE:
Calibrate 3-factor GRM on all TC_* confidence items (What/Where/When domains).
...
- Why this approach: Ordinal TC_* data (5 categories) requires GRM, 3-domain structure per 1_concept.md
...
if __name__ == "__main__":
    try:
        ...
        for domain in IRT_CONFIG['factors']:
            ...
            log(f"[INFO] {domain}: {len(items_in_domain)} items")
        ...
        # Expected output: DataFrame with composite_ID, theta_What, se_What, theta_Where, se_Where, theta_When, se_When
