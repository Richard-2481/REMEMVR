...
if __name__ == "__main__":
    try:
        ...
        log(f"[INFO] Domains: {df_long['domain'].unique().tolist()}")
        ...
        if actual_domains == expected_domains:
            log(f"[VALIDATION] [PASS] Domains correct: {sorted(actual_domains)}")
        else:
            log(f"[VALIDATION] [FAIL] Domain mismatch - Expected: {expected_domains}, Got: {actual_domains}")
            sys.exit(1)
