"""
RQ 6.3.1 - Step 05b: Model Averaging for Domain-Specific Confidence Trajectories

PURPOSE:
Implement Burnham & Anderson (2002) model averaging for domain (What/Where/When)
confidence trajectories with interaction terms.

INPUT:
- data/step04_lmm_input.csv (1200 rows: 100 participants × 4 tests × 3 domains)
- data/step05_model_comparison.csv

INTERACTION FACTOR: domain (What, Where, When)
