...
if __name__ == "__main__":
    try:
        log("[START] Step 00: Extract Confidence Data (Congruence-Based)")
        ...
        # =========================================================================
        # STEP 7: Create Q-Matrix (3-Factor Structure BY CONGRUENCE)
        # =========================================================================
        ...
        log("[CREATE] Creating 3-factor Q-matrix BY CONGRUENCE...")
        ...
        log(f"[CONGRUENCE] Common (i1/i2): {df_q_matrix['factor_common'].sum()} items")
        log(f"[CONGRUENCE] Congruent (i3/i4): {df_q_matrix['factor_congruent'].sum()} items")
        log(f"[CONGRUENCE] Incongruent (i5/i6): {df_q_matrix['factor_incongruent'].sum()} items")
        ...
        if common_count == 0 or congruent_count == 0 or incongruent_count == 0:
            log(f"[FAIL] Q-matrix missing congruence category: Common={common_count}, Congruent={congruent_count}, Incongruent={incongruent_count}")
            validation_passed = False
        else:
            log(f"[PASS] Q-matrix has all 3 congruence categories (Common={common_count}, Congruent={congruent_count}, Incongruent={incongruent_count})")
