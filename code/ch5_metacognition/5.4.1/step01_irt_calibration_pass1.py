#!/usr/bin/env python3
"""IRT Calibration Pass 1 (All TC_* Items): Calibrate 3-factor GRM on all TC_* confidence items (IFR/ICR/IRE paradigms)."""
...
if __name__ == "__main__":
    try:
        ...
        # Tool returns wide format: UID, test, Theta_IFR, Theta_ICR, Theta_IRE
