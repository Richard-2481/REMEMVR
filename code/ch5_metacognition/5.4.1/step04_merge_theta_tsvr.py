...
if __name__ == "__main__":
    try:
        ...
        log(f"[INFO] Paradigms: {df_long['paradigm'].unique().tolist()}")
        ...
        if actual_paradigms == expected_paradigms:
            log(f"[VALIDATION] [PASS] Paradigms correct: {sorted(actual_paradigms)}")
        else:
            log(f"[VALIDATION] [FAIL] Paradigm mismatch - Expected: {expected_paradigms}, Got: {actual_paradigms}")
            sys.exit(1)
